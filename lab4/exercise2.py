...
def stereo_match(left_image, right_image, kernel, max_offset):
    ...
    Image.fromarray(depth).save('depth_image_15_7_30.png')
    print('')
    print('Matching by Sum of square method',prev_ssd)

if __name__ == '__main__':
    stereo_match("images/scene1.row3.col1.ppm", "images/scene1.row3.col5.ppm", 7, 30)